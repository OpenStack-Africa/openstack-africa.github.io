    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <footer style={{
        ...
        <p style={{ fontSize: 13, color: 'var(--text-dim)' }}>
          Built by the African developer community ·{' '}
          <a href="https://twitter.com/chuukkaa_OG" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)', textDecoration: 'none' }}>@chuukkaa_OG</a>
        </p>
        <div style={{ display: 'flex', gap: 20 }}>
          {[
            { href: 'https://github.com/OpenStack-Africa/templates', label: 'GitHub' },
            { href: 'https://docs.n8n.io', label: 'n8n Docs' },
